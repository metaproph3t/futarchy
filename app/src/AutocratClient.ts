...
import { AccountMeta, AddressLookupTableAccount, Keypair, PublicKey } from "@solana/web3.js";
...
export class AutocratClient {
  ...
  async executeProposal(
    ...
    return this.executeProposalIx(proposal, storedProposal.dao, storedProposal.instruction).rpc()
  }
